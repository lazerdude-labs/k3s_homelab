...
function welcome() {
    whiptail --msgbox "Welcome to the Simple K3S Automatic Deployment Script! This script will guide you through the process of deploying a K3S cluster on your infrastructure. Please follow the prompts to set up your cluster.
...
function vault_is_initialized() {
    ...
    options # Brings you back to main menu after check
}
